  ...
  <div id="page-title">
    ...
    <div id="page-title-inner">
      ...
      <div class="container">
        ...
        <h2><i class="ico-stats ico-white"></i>Edit Barang</h2>
...
$(document).ready(function(){
  $('#Gmb').hide();
  var id = <?php echo $_GET['i']?>;

  $.ajax({
      url: "<?php echo base_url('index.php/getdtBrg/') ?>"+id,
      type: "GET",
      dataType: "json",
      success: function(response){
      $('#Nama_Barang').val(response.br_nm);
      $('#Harga').val(response.br_hrg);
      $('#Jumlah').val(response.br_stok);
      $('#Satuan').val(response.br_satuan);
      $('#Deskripsi').val(response.ket);
      $('#nama_gambar').val(response.br_gbr);
      $('#sec-gambar').show();
      $('#gmb_barang').prop("src", "<?php echo base_url('/aset/') ?>"+response.br_gbr);
      }
  });
    ...
    form_data.append('file', file_data);
      $.ajax({
          ...
          success:function(data){
            ...
            $('#sec-gambar').show();
            $('#nama_gambar').val('gambar/'+data.nama);
...
function simpan(){
  ...
  if ($('#nama_gambar').val() !== '') {
      $.ajax({
          url : "<?php echo base_url('index.php/Edit_Barang/') ?>"+id,
          type : "POST",
